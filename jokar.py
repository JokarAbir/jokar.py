...
br.addheaders = [('User-Agent', 'Mozilla/5.0 (Linux; Android 5.1.1; SM-J200H) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.74 Mobile Safari/537.36')]
br.addheaders = [('User-Agent', 'Mac OS X 10.9 - Operating system and version of the client making the request
...
\033[1;96mBlogger \033[1;93m: \033[1;92mhttps://www.facebook.com/JOKAR.ABIR1234
\033[1;91m======================================="""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
